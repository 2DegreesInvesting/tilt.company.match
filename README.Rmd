...
Note that, in very rare cases, we might loose matches this way, however we 
concluded that the improved ease of use justifies those edgecases. Companies that 
have no more  candidates after filtering with the lower threshold are reported.
