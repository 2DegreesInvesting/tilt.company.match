...
The goal of tilt.matching is to provide helpers for matching processes
in the tilt-project,

## Installation

You can install the development version of tilt.matching from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("2DegreesInvesting/tilt.matching")
```
...
use the **check_duplicated_score** function, that checks if a company
has been matched twice (or more) instead of one. (Reminder: the
**accept_match** column in the matched data set should only be set to
