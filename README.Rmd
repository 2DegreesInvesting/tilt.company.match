...
candidates, making the data easier to process for a human. Note that, in very
rare cases, we might loose matches this way, however we concluded that the 
improved ease of use justifies those edgecases.
