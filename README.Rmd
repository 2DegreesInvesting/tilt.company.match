...
consider all companies potential candidates. We treat cases that have postcode but
not country the same way, it would possible induce false positive to match via 
postcode over different countries.
