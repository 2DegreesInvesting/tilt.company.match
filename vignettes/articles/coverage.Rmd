...
exposure output. Please replace the name of sample `loan_amount` column and the
sample loanbook dataset with the original loan amount column name and the original
loanbook dataset!
