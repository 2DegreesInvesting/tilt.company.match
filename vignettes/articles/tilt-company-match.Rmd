...
When matching a company in a bank's loanbook to a company in the tilt
dataset, there are a number of things to consider:
...
For each of the loanbook and tilt datasets, the following must be true:
...
candidates_suggest_match <- candidates_similarity %>%
  ...
  # - It's above a given threshold.
  filter(similarity > suggestions_threshold) %>% 
...
```{r}
# TODO: Replace our "demo" dataset with the file you really edited
# edited <- readr::read_csv("path/to/the/file/you/really/edited.csv")
edited <- demo_matched

# TODO: Replace our "demo" dataset with your real loanbook
# loanbook <- readr::read_csv("path/to/your/real/loanbook.csv")
loanbook <- demo_loanbook
```
...
done. Your final dataset will have as many rows as the number `TRUE` values in
your edited dataset.
