...
You can install it from [r-universe](https://r-universe.dev/) with:

```r
repos <- c("https://2degreesinvesting.r-universe.dev", getOption("repos"))
install.packages("tilt.company.match", repos = repos)
```
