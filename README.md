...
Steps 1 and 3 involve code. You may copy-paste each code chunk or use
our code templates:
...
Here you’ll accept or reject manually the matches suggested before,
using a spreadsheet editor like Excel or GoogleSheets:
...
- For each row decide if you want to reject or accept the suggested
  match. To accept it type TRUE in the column `accept_match`. Else it’ll
  be rejected.
